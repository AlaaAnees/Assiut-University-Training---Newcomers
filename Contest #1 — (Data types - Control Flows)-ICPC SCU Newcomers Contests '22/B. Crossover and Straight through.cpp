...
int main() {
    IAMTRYINGandCRYING;
//two connected devices are of the same type, the cable connecting them is from type Crossover
//if they are different, the cable connecting them is from type Straight through.
//which is if one of the two devices is a computer and the other device is a router, the type of cable connecting between them is Crossover.

string s1,s2; cin>>s1>>s2;
if(s1==s2 || (s1=="computer" && s2=="router") || (s1=="router" && s2=="computer")) cout<<"Crossover";
else cout<<"Straight through";
}
